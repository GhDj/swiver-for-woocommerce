...
<div class="card p-0">
    ...
    <div class="card-body">
            ...
            <div class="vstack gap-2">
                <?php foreach ($taxes as $tax): ?>
                    <div class="d-flex justify-content-between align-items-center p-2 border-bottom">
                        <span>
                            <?php echo esc_html($tax['name'] ?: __('Tax', 'swiver-for-woocommerce')); ?>:
                            <strong><?php echo esc_html($tax['rate']); ?>%</strong>
                        </span>
                        <div class="d-flex align-items-center gap-2">
                            <?php if ($tax['wc']): ?>
                                <span class="badge bg-success"><?php echo esc_html(__('Matched', 'swiver-for-woocommerce')); ?></span>
                                ...
                                <?php endif; ?>
                            <?php else: ?>
                                <span class="badge bg-warning"><?php echo esc_html(__('Not in WooCommerce', 'swiver-for-woocommerce')); ?></span>
                                <button type="button"
                                    ...
                                    <?php echo esc_html(__('Add to WooCommerce', 'swiver-for-woocommerce')); ?>
                                </button>
                            <?php endif; ?>
                        </div>
                    </div>
        ...
        <?php else: ?>
            <p class="text-muted mb-0"><?php echo esc_html(__('No taxes found.', 'swiver-for-woocommerce')); ?></p>
        <?php endif; ?>
    </div>
</div>
