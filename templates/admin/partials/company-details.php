...
<div class="row">
    <div class="col-6">
        <div class="card p-0">
            <h5 class="card-header bg-primary-subtle p-3 text-white"><?php echo esc_html(__('Company Details', 'swiver-for-woocommerce')); ?></h5>
            <div class="card-body">
                <?php if (!empty($company_data) && is_array($company_data)): ?>
                    <div class="vstack gap-3">
                        <?php if (isset($company_data['company']['name'])): ?>
                            <div class="p-2">
                                <h6><?php echo esc_html(__('Company', 'swiver-for-woocommerce')); ?>:</h6>
                        ...
                        <?php if (isset($company_data['user_name'])): ?>
                            <div class="p-2">
                                <h6><?php echo esc_html(__('User Name', 'swiver-for-woocommerce')); ?>:</h6>
                        ...
                        <?php if (isset($company_data['website']) && !empty($company_data['website'])): ?>
                            <div class="p-2">
                                <h6><?php echo esc_html(__('Website', 'swiver-for-woocommerce')); ?>:</h6>
                        ...
                        <?php if (isset($company_data['id'])): ?>
                            <div class="p-2">
                                <h6><?php echo esc_html(__('Integration ID', 'swiver-for-woocommerce')); ?>:</h6>
                                <code><?php echo esc_html($company_data['id']); ?></code>
                            </div>
                        <?php endif; ?>
                    </div>
                <?php else: ?>
                    <p class="text-muted"><?php echo esc_html__('Company data not available.', 'swiver-for-woocommerce'); ?></p>
                <?php endif; ?>
            </div>
        </div>
    </div>
